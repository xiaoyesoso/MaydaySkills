...
The system SHALL support customizable mood arcs. Default arcs are derived from the selected theme template in program-templates.json.
...
### Requirement: Track selection reuses mood matching formula
The system SHALL use the 3-axis scoring formula for track selection at each program segment, referencing mood-taxonomy.md.
...
The system SHALL generate all DJ text following a defined voice guide per dj-voice.md.
